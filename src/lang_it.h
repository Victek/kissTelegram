...
#define LANG_OTA_VALIDATED "✅ FIRMWARE CONVALIDATO\n\nL'aggiornamento è stato completato con successo.\nBackup precedente salvato (usa /reverse per ripristinare).\n\nIl sistema ritorna al funzionamento normale.\nI messaggi in sospeso verranno elaborati ora."
...
#define LANG_OTA_NO_BACKUP "❌ NESSUN BACKUP ESISTENTE\n\nNessun backup disponibile per eseguire la reversione del firmware.\nIl sistema mantiene il firmware attuale."
#define LANG_OTA_BACKUP_EXISTS "⚠️ AVVISO: Backup precedente esistente\n\nSe continui, il backup attuale verrà ELIMINATO.\n\nOpzioni:\n• /otacancel - Annulla OTA\n• /reverse - Ripristina backup precedente\n• /otaconfirmdelete - Elimina backup e continua OTA"
#define LANG_OTA_BACKUP_DELETED "✅ Backup eliminato - Puoi avviare /ota ora"
#define LANG_OTA_NO_BACKUP_DELETE "ℹ️ Nessun backup da eliminare"
#define LANG_OTA_FS_ACCESS_ERROR "❌ Errore di accesso al file system"
#define LANG_OTA_PREPARING_FUTURE "🔄 Preparazione sistema per aggiornamenti futuri...\nRiavvio..."
#define LANG_OTA_NO_PENDING "❌ Nessun OTA in sospeso"
#define LANG_OTA_NO_VALIDATION "❌ /otaok ricevuto ma nessuna validazione in sospeso, ritorno alla modalità normale"
#define LANG_OTA_REVERSE_IDLE_ONLY "❌ Puoi usare /reverse solo quando il sistema è in IDLE"
#define LANG_OTA_REVERSING "🔄 Ritorno al firmware precedente...\n⚠️ NON SPEGNERE"
#define LANG_OTA_REVERSE_COMPLETE "✅ Reversione completata - Riavvio"
#define LANG_OTA_REVERSE_ERROR "❌ Errore di reversione - Il sistema mantiene il firmware attuale"
#define LANG_OTA_NEWFIRM_CONFIRMED "✅ Firmware confermato - Sistema pulito"
#define LANG_OTA_NO_REVERSE_PENDING "❌ Nessuna reversione in sospeso"
#define LANG_OTA_RESTORING_PREVIOUS "🔄 Ripristino firmware precedente..."
