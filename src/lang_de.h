...
#define LANG_OTA_NO_BACKUP "❌ KEIN BACKUP EXISTIERT\n\nKein Backup vorhanden für Firmware-Rückkehr.\nDas System behält die aktuelle Firmware."
#define LANG_OTA_BACKUP_EXISTS "⚠️ WARNUNG: Vorheriges Backup vorhanden\n\nWenn Sie fortfahren, wird das aktuelle Backup GELÖSCHT.\n\nOptionen:\n• /otacancel - OTA abbrechen\n• /reverse - Vorheriges Backup wiederherstellen\n• /otaconfirmdelete - Backup löschen und OTA fortsetzen"
#define LANG_OTA_BACKUP_DELETED "✅ Backup gelöscht - Sie können jetzt /ota starten"
#define LANG_OTA_NO_BACKUP_DELETE "ℹ️ Kein Backup zum Löschen"
#define LANG_OTA_FS_ACCESS_ERROR "❌ Fehler beim Zugriff auf Dateisystem"
#define LANG_OTA_PREPARING_FUTURE "🔄 System wird für zukünftige Updates vorbereitet...\nNeustart..."
#define LANG_OTA_NO_PENDING "❌ Kein ausstehendes OTA"
#define LANG_OTA_NO_VALIDATION "❌ /otaok empfangen aber keine Validierung ausstehend, Rückkehr zum Normalmodus"
#define LANG_OTA_REVERSE_IDLE_ONLY "❌ Sie können /reverse nur verwenden, wenn das System im IDLE-Zustand ist"
#define LANG_OTA_REVERSING "🔄 Rückkehr zur vorherigen Firmware...\n⚠️ NICHT AUSSCHALTEN"
#define LANG_OTA_REVERSE_COMPLETE "✅ Rückkehr abgeschlossen - Neustart"
#define LANG_OTA_REVERSE_ERROR "❌ Rückkehrfehler - System behält aktuelle Firmware"
#define LANG_OTA_NEWFIRM_CONFIRMED "✅ Firmware bestätigt - System sauber"
#define LANG_OTA_NO_REVERSE_PENDING "❌ Keine Rückkehr ausstehend"
#define LANG_OTA_RESTORING_PREVIOUS "🔄 Wiederherstellung der vorherigen Firmware..."
