...
#define LANG_OTA_NO_BACKUP "❌ NO EXISTE BACKUP\n\nNo existe backup para realizar la reversión del firmware.\nEl sistema mantiene el firmware actual."
#define LANG_OTA_BACKUP_EXISTS "⚠️ ADVERTENCIA: Existe backup anterior\n\nSi continúas se BORRARÁ el backup actual.\n\nOpciones:\n• /otacancel - Cancelar OTA\n• /reverse - Restaurar backup anterior\n• /otaconfirmdelete - Borrar backup y continuar OTA"
#define LANG_OTA_BACKUP_DELETED "✅ Backup eliminado - Puedes iniciar /ota ahora"
#define LANG_OTA_NO_BACKUP_DELETE "ℹ️ No hay backup para eliminar"
...
#define LANG_OTA_REVERSE_ERROR "❌ Error en reversión - Sistema mantiene firmware actual"
#define LANG_OTA_NEWFIRM_CONFIRMED "✅ Firmware confirmado - Sistema limpio"
#define LANG_OTA_NO_REVERSE_PENDING "❌ No hay reversión pendiente"
